...
class Macel:
    ...
    def send_ue_to_bs(self, t_index=0, cap_defict=None, t_min=None, bs_2b_updt=None):
    ...
    def simulate_ue_bs_comm(self, ch_gain_map, output_typ='raw'):
        ...
        for time_index, _ in enumerate(self.base_station_list[0].scheduler.time_scheduler.beam_timing_sequence.T):
            ...
            for bs_index, base_station in enumerate(self.base_station_list):
                ...
                for bs_index2, base_station2 in enumerate(self.base_station_list):
                    if bs_index2 != bs_index:
                        ...
                        interf = base_station.tx_power + \
                                 ch_gain_map[bs_index2][ue_in_active_beam, base_station2.scheduler.time_scheduler.beam_timing_sequence[self.sector_map[bs_index2, ue_in_active_beam], v_time_index]]  # AQUI OI
                ...
                # TODO - ALTERAR AQUI PARA SEMPRE USAR O USER_BW AO INVES DO BEAM BW (TAMBÉM NO OBJETO DO SCHEDULER)
                if base_station.scheduler.freq_scheduler.user_bw is None:  # uniform beam bw
                    ...
                    bw = base_station.scheduler.freq_scheduler.user_bw[ue_in_active_beam]
