...
def simulate_macel_downlink(args):  # todo - fix the and check all the options here
    ...
    macel.grid.make_points(dist_type='gaussian', samples=n_samples, n_centers=n_bs, random_centers=False,
    ...
    snr_cap_stats, raw_data = macel.place_and_configure_bs(n_centers=n_bs, output_typ='complete',
                                                           clustering=False, predetermined_centroids=predetermined_centroids)
