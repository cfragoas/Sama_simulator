...
class Metrics:
    ...
    def create_uplink_metrics_dataframe(self, output_typ, active_ue, cluster_centroids, ue_pos,ue_char,ue_prop_sce, ue_bs_table, dist_map,
                                        scheduler_typ=None):
    ...
    def create_downlink_metrics_dataframe(self, output_typ, active_ue, cluster_centroids, ue_pos,ue_char,ue_prop_sce, ue_bs_table, dist_map,
                                          scheduler_typ=None):
        # this function will format the metrics after the simulation has ended in a dictionary format to make a backup
        # and plot some data
        # this dictionary is divided in simple pre-calculated metrics and raw metrics
